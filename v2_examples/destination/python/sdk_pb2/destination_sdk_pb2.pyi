...
class WriteBatchRequest(_message.Message):
    __slots__ = ("configuration", "schema_name", "table", "keys", "replace_files", "update_files", "delete_files", "csv", "parquet")
    class ConfigurationEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    csv: CsvFileParams
    parquet: ParquetFileParams
    def __init__(self, configuration: _Optional[_Mapping[str, str]] = ..., schema_name: _Optional[str] = ..., table: _Optional[_Union[_common_pb2.Table, _Mapping]] = ..., keys: _Optional[_Mapping[str, bytes]] = ..., replace_files: _Optional[_Iterable[str]] = ..., update_files: _Optional[_Iterable[str]] = ..., delete_files: _Optional[_Iterable[str]] = ..., csv: _Optional[_Union[CsvFileParams, _Mapping]] = ..., parquet: _Optional[_Union[ParquetFileParams, _Mapping]] = ...) -> None: ...
...
class ParquetFileParams(_message.Message):
    __slots__ = ("encryption",)
    ENCRYPTION_FIELD_NUMBER: _ClassVar[int]
    encryption: Encryption
    def __init__(self, encryption: _Optional[_Union[Encryption, str]] = ...) -> None: ...
